...
import (
	...
	"github.com/mailcache/mailcache-server/api"
	cfgapi "github.com/mailcache/mailcache-server/config"
	"github.com/mailcache/mailcache-server/smtp"
...
func main() {
	if len(os.Args) > 1 && (os.Args[1] == "-version" || os.Args[1] == "--version") {
		fmt.Println("MailCache version: " + version)
		os.Exit(0)
	}
