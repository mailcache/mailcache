...
### [v1.0.0](https://github.com/sureshinde/mailcache/releases/v1.0.0)
...
- Fix #148 and mailcache/storage#7 - leading \r\n in maildir storage
...
- #136 - update MailCache-UI assets, thanks @sdurrheimer
- #145 - fix a link in DEPLOY.md, thanks @nnmer
- sureshinde/mailcache-ui#22 and #104 - support TLS websockets in HTTPS mode, thanks @blueimp
- sureshinde/mailcache-ui#23 and sureshinde/mailcache-ui#24 - support multiple instances of CID, thanks @kieran and @jerbob92
- more things I've forgotten/can't find!

### [v0.2.1](https://github.com/sureshinde/mailcache/releases/v0.2.1)
...
- #93 - starting MailCache as a service using brew, thanks @espen
...
- mailcache/smtp#2 - use file modification time for Created field, thanks @esiqveland

### [v0.2.0](https://github.com/sureshinde/mailcache/releases/v0.2.0)
- mailcache/storage#1 - fix MongoDB storage bug, and implement search, thanks @HokieTT
- #13 - implement file based storage backend (currently without search)

### [v0.1.9](https://github.com/sureshinde/mailcache/releases/v0.1.9)
- #76 - optimise docker image size, thanks @missedone
- #77 - fix ci by removing go-uuid, thanks @missedone
- #80, sureshinde/mailcache-ui#15, sureshinde/mailcache-server#2 - add webpath, thanks @oers
- sureshinde/mailcache-ui#13 - create hyperlinks for URLs in plain text, thanks @GREsau
- sureshinde/mailcache-ui#14 - add no-referrer referrer policy, thanks @djmattyg007

### [v0.1.8](https://github.com/sureshinde/mailcache/releases/v0.1.8)
- Add `MailCache sendmail` shortcut to `mhsendmail`
- Add #40 - HTTP basic authentication
- Add #63 - message size in UI
- Fix sureshinde/mailcache-ui#10 - fix delete for in-memory storage
- Merge sureshinde/mailcache-ui#8 - fix styles for .content positioning, thanks @thejameskyle
- Merge sureshinde/mailcache-ui#9 - fix content types, thanks @danielwhite
- Merge mailcache/data#4 - factor out use of log package, thanks @ishbir

### [v0.1.7](https://github.com/sureshinde/mailcache/releases/v0.1.7)
- Add [mhsendmail](https://github.com/mailcache/mhsendmail) sendmail replacement
...
- Fix sureshinde/mailcache-ui#6 - user defined pagination
- Merge #43 and #44 - fix documentation, thanks @eirc
- Merge #48 - fix documentation, thanks @zhubert
- Merge sureshinde/mailcache-server#1 - avoid duplicate headers, thanks @wienczny

### [v0.1.6](https://github.com/sureshinde/mailcache/releases/v0.1.6)
- Fix #24 - base64 attachments/mime part downloads
- Fix #28 - embed js/css/font assets for offline use
- Fix #29 - overview of MailCache for readme
- Fix #34 - message list scrolling
- Fix #35 - message list sorting
- Fix #36 - document outgoing SMTP server configuration and APIv2
- Merge sureshinde/mailcache-ui#4 - support base64 content transfer encoding, thanks @stekershaw
- Merge mailcache/Mailhog-UI#5 - single part encoded text/plain, thanks @naoina

### [v0.1.5](https://github.com/sureshinde/mailcache/releases/v0.1.5)
- Fix sureshinde/mailcache-ui#3 - squashed subject line

### [v0.1.4](https://github.com/sureshinde/mailcache/releases/v0.1.4)
- Merge mailcache/data#2 - MIME boundary fixes, thanks @nvcnvn
- Merge sureshinde/mailcache-ui#2 - UI overhaul, thanks @omegahm
- Fix #31 - updated this file :smile:

### [v0.1.3](https://github.com/sureshinde/mailcache/releases/v0.1.3)
- Fix #22 - render non-multipart messages with HTML content type
- Fix #25 - make web UI resource paths relative

### [v0.1.2](https://github.com/sureshinde/mailcache/releases/v0.1.2)
...
### [v0.1.1](https://github.com/sureshinde/mailcache/releases/v0.1.1)
...
### [v0.1.0](https://github.com/sureshinde/mailcache/releases/v0.1.0)
...
### [v0.09](https://github.com/sureshinde/mailcache/releases/0.08)

- Fix #8 - add Chaos Monkey ([Jim](JIM.md)) to support failure testing

### [v0.08](https://github.com/sureshinde/mailcache/releases/0.08)
...
### [v0.07](https://github.com/sureshinde/mailcache/releases/tag/0.07)

- Fix #6 - Make SMTP verbs case-insensitive

### [v0.06](https://github.com/sureshinde/mailcache/releases/tag/0.06)

- Fix #5 - Support leading tab in multiline headers

### [v0.05](https://github.com/sureshinde/mailcache/releases/tag/0.05)

- Add #4 - UI support for RFC2047 encoded headers

### [v0.04](https://github.com/sureshinde/mailcache/releases/tag/0.04)
...
### [v0.03](https://github.com/sureshinde/mailcache/releases/tag/0.03)
...
### [v0.02](https://github.com/sureshinde/mailcache/releases/tag/0.02)
...
### [v0.01](https://github.com/sureshinde/mailcache/releases/tag/0.01)
